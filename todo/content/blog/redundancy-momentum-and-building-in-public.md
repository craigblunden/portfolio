...
I joined Repeat.gg during Covid-19 as employee number seven as a Senior Front End Developer. Back then it was a small startup with a big idea: a
...
acquired us and folded us into the wider PlayStation family where I was promoted to a Fullstack Software Engineer.
...
thousands of people updating the scoreboards the same time." Most of that lived in an event-driven,
...
I'm running a focused five-month sprint on two tracks: the job search, and building out my skillset for the current market being well rounded and using agentic workflows for productivity. The products I build is where I'm closing the biggest gap on my CV. My career has been
